...
@section('content')
    ...
    <div class="container-fluid mt-5">
        <h2 class="mx-3">Active Projects</h2>
        ...
        <button class="btn btn-success mx-3 mb-3 mt-3" onclick="downloadPdf1()">
   ...
   <div class="container-fluid">
     <table class="table table-striped border" id="active_projects">
